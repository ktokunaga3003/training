...
<body>
	...
	<div id="mainArea">
		...
		現在のポイント数は<c:out value="${sessionScope.CommonLoginMember.memberPoint}"/>ポイントです。

		<h2>会員情報</h2>
		<table border="1">
		    <tr>
		        <th>会員ID</th>
		        <td><c:out value="${sessionScope.CommonLoginMember.memberId}"/></td>
		    </tr>
		    <tr>
		        <th>名前</th>
		        <td><c:out value="${sessionScope.CommonLoginMember.memberName}"/></td>
		    </tr>
		    <tr>
		        <th>住所</th>
		        <td><c:out value="${sessionScope.CommonLoginMember.address}"/></td>
		    </tr>
		    <tr>
		        <th>電話番号</th>
		        <td><c:out value="${sessionScope.CommonLoginMember.phone}"/></td>
		    </tr>
		</table>
		...
		<br>
		<br>
		<a href="/freemarknProto/mserv?flag=XXXX">[会員情報更新]</a>&nbsp;&nbsp;
